...
public class preparation1: UIViewController{
    ...
    var steps : [String] = ["Measure 20 gram coffee beans to the empty glass by dragging it.",
            "After measure the coffee beans, now set the grinder to medium-course and grind the coffee beans.",
            "Congrats, preparation 1 finish."]
    ...
    func setupView(){
        ...
        title1.text = "Preparation measure and grind coffee beans"
        title1.font = UIFont.boldSystemFont(ofSize: 26)
        ...
        details.text = "In this preparation we use 1:16 ratio, it means 1 gram coffee = 16 ml hot water."
        ...
        instruction.text = "We will use 20 gram coffee beans for make manual brew"
        ...
        preparationV0.image = UIImage(named: "emptyGlass.png")
        ...
        preparationV1.image = UIImage(named: "20grBeans.png")
        ...
        preparationV2.image = UIImage(named: "20grBeansGrinded.png")
        ...
        Act1Label.text = "1. 20 gram coffee beans"
    ...
    @objc func btnNextScreen(sender: UIButton) {
        navigationController?.pushViewController(preparation2(), animated: true)
    }
